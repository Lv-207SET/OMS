...
//    private static XSSFRow SheetRow;
    ...
    public static String getSpecifficCellData(int Row, int Column) throws Exception {// todo catch exetionss
    ...
    private static List<UserEntity> readUesrsData(String sheetName) {
       ...
       // TODO DELITE COMMENTS
        // user has next fields: firstName, lastName, password, login, email, region, role
       /* for (int field = 0; field <= 7; field ++){
        }*/
        
        for (Object[] userField : users) {
            UserEntity user = new UserEntity.Builder()
                    .setFirstName(userField[0].toString())
                    .setLastName(userField[1].toString())
